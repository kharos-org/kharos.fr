...
(function () {
  ...
  var Tp = 0.1; // h/device/rotation    (≈6 min — low end)
  ...
  var O = 0.1; // onboarding rate (% of fleet)
  ...
  var LABELS = ["802.1x & HTTPS certs", "Password rotation", "Network config", "Audit prep", "Device onboarding", "Cert expiry incidents"];
